...
namespace ParquetClassLibrary
{
    ...
    public struct AssemblyInfo
    {
        ...
        /// <summary>
        /// A subset of the values of <see cref="EntityID"/> set aside for
        ...
        /// <summary>
        /// A subset of the values of <see cref="EntityID"/> set aside for items.
        ...
        /// <summary>
        /// A subset of the values of <see cref="EntityID"/> set aside for critters.
        /// Valid identifiers may be positive or negative.  By convention, negative IDs indicate test Items.
        /// </summary>
        ...
        /// Valid identifiers may be positive or negative.  By convention, negative IDs indicate test Items.
        /// </summary>
        public static readonly Range<EntityID> RoomRecipeIDs = new Range<EntityID>(70000, 79000);

        /// <summary>
        /// A subset of the values of <see cref="EntityID"/> set aside for crafting recipes.
        /// Valid identifiers may be positive or negative.  By convention, negative IDs indicate test Items.
        /// </summary>
        public static readonly Range<EntityID> CraftingRecipeIDs = new Range<EntityID>(80000, 89000);

        /// <summary>
        /// A subset of the values of <see cref="EntityID"/> set aside for quests.
        /// Valid identifiers may be positive or negative.  By convention, negative IDs indicate test Items.
        /// </summary>
        public static readonly Range<EntityID> QuestIDs = new Range<EntityID>(90000, 99000);
        #endregion
        ...
        /// <summary>The length of each <see cref="Sandbox.MapRegion"/> dimension in <see cref="T:ParquetClassLibrary.Sandbox.MapChunkGrid"/>s.</summary>
